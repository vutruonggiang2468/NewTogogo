          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="text-lg font-semibold text-center text-slate-200 mb-4 tracking-wide">Top cổ đông lớn</div>
                <div className="text-center p-6 bg-gradient-to-br from-slate-700/30 to-cyan-500/20 rounded-xl border-2 border-cyan-400/30">
                  <div className="text-lg font-medium text-white mb-2">{largest?.share_holder}</div>
                  <div className="text-3xl font-bold text-cyan-400 mb-2">
                    {pct}%
                  </div>
                  <Progress value={parseFloat(largest?.share_own_percent)} className="h-1.5" />
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-slate-700/30 to-cyan-500/20 rounded-xl border-2 border-cyan-400/30">
                  <div className="text-lg font-medium text-white mb-2">{largest1?.share_holder}</div>
                  <div className="text-3xl font-bold text-cyan-400 mb-2">
                    {pct1}%
                  </div>
                  <Progress value={parseFloat(largest1?.share_own_percent)} className="h-1.5" />
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-slate-700/30 to-cyan-500/20 rounded-xl border-2 border-cyan-400/30">
                  <div className="text-lg font-medium text-white mb-2">{largest2?.share_holder}</div>
                  <div className="text-3xl font-bold text-cyan-400 mb-2">
                    {pct2}%
                  </div>
                  <Progress value={parseFloat(largest2?.share_own_percent)} className="h-1.5" />
                </div>
              </div>
              <div className="space-y-4">
                <span className="text-slate-400 text-sm font-medium mb-3 block">Cổ đông</span>
                <div className="space-y-3">

                  <div className="p-4 bg-slate-700/30 backdrop-blur-sm rounded-xl border border-cyan-400/20">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <div className="font-medium text-white text-sm mb-1">{largest3?.share_holder}</div>
                    ...
                    <Progress value={parseFloat(largest3?.share_own_percent)} className="h-1.5" />
                  </div>

                  <div className="p-4 bg-slate-700/30 backdrop-blur-sm rounded-xl border border-cyan-400/20">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <div className="font-medium text-white text-sm mb-1">{largest4?.share_holder}</div>
                        <div className="text-pg font-bold text-cyan-400 mb-2">
                          {pct4}%
                        </div>
                        {/* <div className="text-xs text-slate-400">{largest3.share_own_percent}</div> */}
                  ...
                  <div className="p-4 bg-slate-700/30 backdrop-blur-sm rounded-xl border border-cyan-400/20">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <div className="font-medium text-white text-sm mb-1">{largest5?.share_holder}</div>
                        <div className="text-pg font-bold text-cyan-400 mb-2">
                          {pct5}%
                        </div>
                        {/* <div className="text-xs text-slate-400">{largest3.share_own_percent}</div> */}
                    ...
                    <Progress value={parseFloat(largest5?.share_own_percent)} className="h-1.5" />
                  </div>
                </div>
              </div>
            </div>
