...
import type { StockAnalysis } from "@/app/viewdetails/types";

export const getStockAnalysis = (code: string): StockAnalysis => {
  return stockDatabase[code as keyof typeof stockDatabase] || stockDatabase.VSC;
};

export const calculateMarketPosition = (currentPrice: string, week52Low: string, week52High: string): number => {
...
export const getAnimatedValues = (stock: StockAnalysis): AnimatedValues => {
  return {
